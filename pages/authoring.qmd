...
- [Custom Kernels for All from Codex and Claude](https://huggingface.co/blog/custom-cuda-kernels-agent-skills) (with Ben, Aritra, and Shaun)
...
* [Faster Diffusion on Blackwell: MXFP8 and NVFP4 with Diffusers and TorchAO](https://pytorch.org/blog/faster-diffusion-on-blackwell-mxfp8-and-nvfp4-with-diffusers-and-torchao/). [Tweet](https://x.com/PyTorch/status/2041923082353320443?s=20) from PyTorch.
* [Helion x 🤗 HF Kernels: Building and Shipping Out-of-the-box Performant Kernels](https://pytorch.org/blog/helion-x-%f0%9f%a4%97-hf-kernels-building-and-shipping-out-of-the-box-performant-kernels/). [Tweet](https://x.com/PyTorch/status/2098471725834862804?s=20) from PyTorch.
:::
