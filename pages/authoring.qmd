...
- [🧨 Diffusers welcomes Stable Diffusion 3](https://huggingface.co/blog/sd3) (Diffusers team).
- [Memory-efficient Diffusion Transformers with Quanto and Diffusers](https://huggingface.co/blog/quanto-diffusers) (with [David Corvoysier](https://huggingface.co/dacorvo)).
- [🧨 Diffusers welcomes Stable Diffusion 3.5 Large](https://huggingface.co/blog/sd3-5) (Diffusers team).
- [Open Preference Dataset for Text-to-Image Generation by the 🤗 Community](https://huggingface.co/blog/image-preferences) (multiple authors from Hugging Face).
...
- [Remote VAEs for decoding with Inference Endpoints 🤗](https://huggingface.co/blog/remote_vae) (with [hlky](https://huggingface.co/hlky)).
