...
## What is GSPO? A Smarter Way to Learn
...
![A detailed diagram showing the GSPO workflow. Step 1: A prompt goes to the Policy Model which generates multiple output sequences. Step 2: The sequences are scored by reward functions. Step 3: A Sequence Advantage is computed from the scores. Step 4: The advantage is used to update the policy model, with a KL divergence check against a reference model.](https://i.imgur.com/GzB1tJk.png)
